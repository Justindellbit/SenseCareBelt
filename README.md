# SenseCareBelt
## Intitule du projet :
     ***SenseCare Belt – Intelligent Safety for Vulnerable Users***

Le projet SenseCareBelt est une solution technologique conçue pour répondre à un problème fréquent dans les centres hospitaliers, les maisons de retraite, les centres de détention pour personnes âgées ou encore les domiciles accueillant des personnes vulnérables.

## Objectif principal: 
  Détecter rapidement la chute d’un individu afin de déclencher une intervention immédiate et ainsi réduire les risques liés au retard de prise en charge.
 La fusion des technologies qui permettent d’obtenir des informations fiables sur l’activité du porteur.
